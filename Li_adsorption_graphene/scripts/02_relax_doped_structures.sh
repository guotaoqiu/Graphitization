#!/bin/bash
################################################################################
# Script to batch submit relaxation jobs for doped graphene structures
...
echo "================================================================================"
echo "Batch Submission of Doped Graphene Relaxation Jobs"
echo "================================================================================"
...
# Find all doped structure files (excluding pristine)
echo "Searching for doped structures..."
echo ""

for structure_file in "$STRUCTURE_DIR"/graphene_*_doped.vasp; do
    if [ ! -f "$structure_file" ]; then
        echo "No doped structure files found in $STRUCTURE_DIR"
        break
    fi
...
echo "  2. After jobs complete, check results: ./02b_check_doped_relaxation.sh"
echo "  3. Then generate Li adsorption structures: python3 03_generate_li_adsorption.py"
echo "================================================================================"
